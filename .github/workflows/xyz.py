...
api_token = os.environ.get('XYZCLOUDFLARE_API_TOKEN')
zone_id = os.environ.get('XYZZONE_ID')
...
if response.status_code == 200:
    ...
    send_telegram_notification(f"XYZ无法获取DNS记录信息。响应代码: {response.status_code}")
